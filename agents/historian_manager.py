...
- Your name in this conversation is {historian_name}"""
    ...
    def save_personas(self, output_path: str = "data/agent_experiments/historian_personas.json"):
    ...
    def load_personas(self, input_path: str = "data/agent_experiments/historian_personas.json"):
