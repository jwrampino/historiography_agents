...
Usage:
    python -m historian_pipeline.pipeline --query "reconstruction era" --max-items 500
    python -m historian_pipeline.pipeline --config pipeline_config.json
"""
...
from historian_pipeline.config.settings import (
    BASE_DIR,
    LOC_API_KEY,
    SMITHSONIAN_API_KEY,
    NARA_API_KEY,
...
from historian_pipeline.ingestors.loc_ingestor import LOCIngestor, ChroniclingAmericaIngestor
from historian_pipeline.ingestors.internet_archive_ingestor import InternetArchiveIngestor
from historian_pipeline.ingestors.nara_smithsonian_ingestor import NARAIngestor, SmithsonianIngestor
